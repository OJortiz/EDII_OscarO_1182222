    ...
    public class ArithmeticCompressionInt
    {
        ...
        public MemoryStream Compress(string input)
        {
            ...
            foreach (char symbol in input)
            {
                ...
                // Punto de depuración
                //Console.WriteLine($"Symbol: {symbol}, Low: {low}, High: {high}, Range: {range}");
                ...
                while (true)
                {
                    ...
                    // Punto de depuración
                    //Console.WriteLine($"Normalization - Low: {low}, High: {high}, Underflow bits: {underflow_bits}");
        ...
        public string Decompress(MemoryStream input, int size)
        {
            ...
            for (int i = 0; i < size; i++)
            {
                ...
                // Punto de depuración
                Console.WriteLine($"Symbol: {symbol}, ScaledValue: {scaledValue}, Low: {low}, High: {high}");
                ...
                while (true)
                {
                    ...
                    // Punto de depuración
                    Console.WriteLine($"Normalization during decompression - Low: {low}, High: {high}, Code: {code}");
